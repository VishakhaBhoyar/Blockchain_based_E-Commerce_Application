...
if($obj->StoreProduct($pname,$price,$desc,$mfd,$dis_ID,$dis_name,$city,$qty,$main_cate,$sub_cate,$unit,$psize,$status)==1)
{
    ...
    <body class=" ">
                        ...
                        <section class="box ">
                            <header class="panel_header">
                                <div class="col-md-12">
                                    ...
                                    <a href="view-product.php"><button type="button" class="btn btn-info">View Products</button></a>
       ...
       <form action="#" method="post" enctype=""> 
                                    <div class="col-md-8 col-sm-9 col-xs-10">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="field-2">Product Price</label><br/>
                                             <!---<strong>Note: Kindly insert price as per Packaging Size</strong>-->
                                            <div class="controls">
...
$typeb= 'Distributor';			
  $stmt = $obj1->db->prepare("SELECT * FROM ep_user WHERE TYPE_BUSINESS='$typeb'"); // $obj->db is refer to the connection db is the public variable define in ADB_Fuctions file
			$stmt->execute();
               ...
               <option value="<?php echo $row['USER_ID']; ?>:<?php echo $row['NAME_BUSINESS']; ?>"><?php echo $row['NAME_BUSINESS']; ?></option>
                                                      <?php }?> 
                                                </select>
                                            </div>
                                        </div>
