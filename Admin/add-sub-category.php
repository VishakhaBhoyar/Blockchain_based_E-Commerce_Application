...
if($obj->StoreSubCategory($main_cate,$sub_cate,$status)==1)
{
echo "<script>alert('Sub - Category set successfully');</script>";
}
else{
       ...
       <form action="#" method="post" enctype=""> 
                                    <div class="col-md-8 col-sm-9 col-xs-10">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="field-2">Name of Sub category</label>
                                          
                                            <div class="controls">
                                                <input type="text" value="<?php //echo $row['stud_name']; ?>" name="sub_cate" required="required"  class="form-control" id="field-2" >
                                            </div>
                                        </div>
                                   <?php	
  ...
  $id=$_GET['Eid']; /// Here we are geting the id from view-code-list.php file
			...
			$stmt->execute();
                ...
                <?php while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {?>
                     ...
                     <div class="controls">
                         <input type="submit" class="btn btn-primary" value="Add Sub Category" id="txtPhone">
                     </div>
                 </div>
