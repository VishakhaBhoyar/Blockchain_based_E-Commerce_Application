                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">View client list</h1>                            </div>
...
<?php        
		...
		if($_GET['id1']=="done")
		{
		echo "<center><span style='color:red'><strong>Album Deleted</strong></span></center>";
		}
		if($_GET['id1']=="notdone")
		{
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Details of client</h2>
                                            ...
                                            <table cellspacing="0" id="tech-companies-1" class="table table-small-font table-bordered table-striped">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th data-priority="1">Preference</th>
                                                       
                                                        <th data-priority="3">View Profile</th>
  ...
  $sql = $obj->db->prepare("select * from stud_general");
		...
		$sql->execute();
			...
			?> 
                                                    <tr>
                                                       ...
                                                       <td><a href="delete-client-list.php?id=<?php echo $row['ID']; ?>" class="btn btn-info">Delete Profile</a></td>
                                                    </tr>      
                                          <?php } ?>          
                                                </tbody>
                                            </table>
...
if($obj->Deleteclient($id)==1)
{
	echo "<script>window.location='delete-client-list.php?id1=done';</script>";
}
