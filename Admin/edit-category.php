...
if($obj->UpdateCategory($id,$category_name,$status)==1)
{
...
<head>
                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Update Category</h1>                            </div>
                        ...
                        <section class="box ">
                            <header class="panel_header">
                                <div class="col-md-12">
                                    ...
                                    <a href="view-category.php"><button type="button" class="btn btn-info">View Category</button></a>
  ...
  $id=$_GET['Eid']; /// Here we are geting the id from view-code-list.php file
			...
			$stmt = $obj1->db->prepare("SELECT * FROM ep_category WHERE CAT_ID = '".$id."'"); // $obj->db is refer to the connection db is the public variable define in ADB_Fuctions file
			$stmt->execute();
       ...
       <form action="#" method="post" enctype=""> 
           <input type="hidden" value="<?php echo $row['CAT_ID']; ?>" name="id" readonly="readonly" />
                                    <div class="col-md-8 col-sm-9 col-xs-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" value="<?php echo $row['CATEGORY_NAME']; ?>" name="category"  class="form-control" id="field-2" >
                                            </div>
                                        </div>
                     ...
                     <div class="controls">
                         <input type="submit" class="btn btn-primary" value="Update Category" id="txtPhone">
                     </div>
                 </div>
