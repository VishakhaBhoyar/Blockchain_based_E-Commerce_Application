...
<!-- Mirrored from jaybabani.com/ultra-admin/tables-responsive.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 May 2015 10:40:56 GMT -->
<head>
        <!-- 
                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">View Product List</h1>                            </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="wid-uprofile bg-warning">
                                            ...
                                            <div class="uprofile-name">
                                                ...
                                                <p class="uprofile-title"><strong>Product Type: </strong> <?php echo $row['PRODUCT_TYPE']; ?> </p>
                                            </div>
                                            <div class="uprofile-info">
                                                <ul class="list-unstyled">
                                                    <li><i class='fa fa-suitcase'></i><strong> Price:</strong> <?php echo $row['PRICE']; ?> Rs.</li>
                                                    <li><i class='fa fa-suitcase'></i><strong> Description:</strong> <?php echo $row['DESCRIPTION']; ?></li>
                                                    <li><i class='fa fa-suitcase'></i><strong> Quantity: </strong> <?php echo $row['QTY']; ?></li>
                                                    <li><i class='fa fa-suitcase'></i><strong> Manufactured by: </strong> <?php echo $row['MANUFACTRE']; ?></li>
                                                </ul>
                                            </div>
                                            
<div class=" uprofile-social">

                                                <a href="edit-product.php?Eid=<?php echo $row['PD_ID']; ?>" class="btn btn-primary btn-big">Edit </a>
                                                <a href="delete-product.php?Did=<?php echo $row['PD_ID']; ?>" class="btn btn-primary btn-danger">Delete</a>
