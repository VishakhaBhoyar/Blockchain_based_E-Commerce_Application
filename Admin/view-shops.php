...
<head>
                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">View User List</h1>                            </div>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                ...
                                <h2 class="title pull-left">Details of Users</h2>
  ...
  $rit= 'Retailer';
  $sql = $obj->db->prepare("select * from ep_user WHERE TYPE_BUSINESS='$rit'");
		
		$sql->execute();
		$i=0;
			
		    while($row = $sql->fetch(PDO::FETCH_ASSOC)) { $i++;
