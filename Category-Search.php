...
<div style="margin: 8px auto; display: block; text-align:center;">
	...
	<!-- Single Page -->
    <h2 class="title text-center">Search for <?php echo $_GET['id']; ?></h2>
...
?>   
 ...
 <?php	
  ...
  $sql = $obj->db->prepare("select * from ep_product where PRODUCT_TYPE='$name'");
			
		$sql->execute();
		
			if($sql->rowCount()==0){
				echo "<h1>Sorry We dont found any Product </h1>";
				}
...
<th>Price</th>
   ...
   <tbody>
      <tr>
        <th><img src='images/product_demo.jpg' alt='' style="height:100px; width:100px;"/><br>
