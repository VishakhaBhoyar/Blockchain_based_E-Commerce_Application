...
return 0;
 ...
 function proof_of_work($blockchainid,$minid,$order_id,$p_id)
 {
$sql =$this->db->prepare("INSERT INTO `proof_of_work` (`blockchain_id`, `miners_id`, `order_id`, `P_id`, `status`) VALUES(:blockchainid,:minid,:order_id,:p_id,'1')");
...
return 0;
 ...
 function proof_of_work1($blockchainid,$minid,$order_id,$p_id)
 {
$sql =$this->db->prepare("INSERT INTO `proof_of_work` (`blockchain_id`, `miners_id`, `order_id`, `P_id`, `status`) VALUES(:blockchainid,:minid,:order_id,:p_id,'0')");
